    ...
    <div className="max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Card className="lg:col-span-2 p-6 border-border bg-surface shadow-soft space-y-5">
          <h3 className="font-semibold text-[color:var(--brand-night)]">Informations personnelles</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2"><Label>Nom complet</Label><Input defaultValue={user.name} /></div>
            <div className="space-y-2"><Label>Adresse e-mail</Label>
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <Link to="/reset-password"><Button variant="outline" className="gap-2"><KeyRound className="h-4 w-4" /> Changer mon mot de passe</Button></Link>
          </div>
        </Card>
      </div>
    </div>
